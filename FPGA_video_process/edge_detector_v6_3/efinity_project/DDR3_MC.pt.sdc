...
# LVDS Tx Constraints
#######################
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~175}] -max 0.378 [get_ports {tmds_tx_clk_TX_DATA[*]}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~175}] -max 0.378 [get_ports {tmds_tx_clk_TX_OE}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~215}] -max 0.378 [get_ports {tmds_tx_data0_TX_DATA[*]}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~215}] -max 0.378 [get_ports {tmds_tx_data0_TX_OE}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~187}] -max 0.378 [get_ports {tmds_tx_data1_TX_DATA[*]}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~187}] -max 0.378 [get_ports {tmds_tx_data1_TX_OE}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~200}] -max 0.378 [get_ports {tmds_tx_data2_TX_DATA[*]}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~200}] -max 0.378 [get_ports {tmds_tx_data2_TX_OE}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~175}] -max 0.420 [get_ports {tmds_tx_clk_TX_RST}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~215}] -max 0.420 [get_ports {tmds_tx_data0_TX_RST}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~187}] -max 0.420 [get_ports {tmds_tx_data1_TX_RST}]
...
set_output_delay -clock hdmi_rx_slow_clk -reference_pin [get_ports {hdmi_rx_slow_clk~CLKOUT~218~200}] -max 0.420 [get_ports {tmds_tx_data2_TX_RST}]
